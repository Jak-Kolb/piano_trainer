...
export const COLOR_PROFILES: ColorProfile[] = [
  ...
  },
  {
    ...
    vars: {
      '--color-ink': '#F3E6C8',
      '--color-ink-raised': '#F7EDD8',
      '--color-ink-soft': '#FFF6E4',
      '--color-ivory': '#1F1812',
      '--color-ivory-dim': '#3A2E24',
      '--color-dust': '#6B5A45',
      '--color-dust-muted': '#8A7660',
      '--color-felt': '#9B3B3B',
